...
/** @typedef {{[key: string]: any}} AsyncState */
...
class PerfAgent {
    ...
    _asyncInit(asyncId, type, triggerAsyncId) {
        ...
        const prevState = prevNode ? prevNode.state : null;
        const state = Object.create(prevState);
    ...
    set(key, value) {
        ...
        if (node) return (node.state[key] = value);
    }
}
